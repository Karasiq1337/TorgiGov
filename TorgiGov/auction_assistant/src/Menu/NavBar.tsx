    ...
    return (
        <Navbar expand="lg" className="bg-body-tertiary">
            <Container fluid>
                ...
                <Navbar.Collapse>
                    <Nav className={"me-3"}>
                        <NavLink className={" border"}>Личный кабинет</NavLink>
                        <NavLink className={" text-center border"}>Список лотов</NavLink>
                        <NavLink className={" border"}>
                            <NavDropdown title={"Сравнить"}>
                                <NavDropdown.Item href={"Аренда"}>Аренда</NavDropdown.Item>
                                <NavDropdown.Item href={"Продажа"}>Продажа</NavDropdown.Item>
                            </NavDropdown>
                        </NavLink>
                        <NavLink className={"border"}>Статистика</NavLink>
                    </Nav>
                    <InputGroup className="justify-content-">
